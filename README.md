[![Build Status](https://dev.azure.com/glenntess/ContosoAir/_apis/build/status%2Fglenntess.ContosoAir?branchName=master)](https://dev.azure.com/glenntess/ContosoAir/_build/latest?definitionId=31&branchName=master)
